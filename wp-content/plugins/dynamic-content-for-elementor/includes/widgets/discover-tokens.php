...
class DiscoverTokens extends \DynamicContentForElementor\Widgets\WidgetPrototype
{
    ...
    protected function get_demo()
    {
        return [
            ...
            'product' => [
                // Description to show before the table
                'description' => __('This token is useful for retrieving the fields of the currente WooCommerce product', 'dynamic-content-for-elementor'),
                // Plugin dependencies
            ...
            'option' => [
                // Description to show before the table
                'description' => __('This token is useful for retrieving options. Options are pieces of data that WordPress uses to store various preferences and configuration settings. You can also retrieve Advanded Custom Fields and JetEngine Fields created on options pages', 'dynamic-content-for-elementor'),
                // Static fields to show
                'fields' => [],
                // Functions to populate fields
            ...
            'term' => [
                // Description to show before the table
                'description' => __('This token is useful for retrieving the fields of the current term on a Term Archive', 'dynamic-content-for-elementor'),
                // Functions to generate ID
