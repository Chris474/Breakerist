...
class BaseController
{
    ...
    public  $oum_marker_types_label_default = 'Type' ;
    ...
    public function render_block_map( $block_attributes, $content )
    {
        ...
        //https://unpkg.com/leaflet-geosearch@3.1.0/dist/geosearch.css
        wp_enqueue_style(
        ...
        wp_enqueue_script(
            ...
            array( 'oum_leaflet_providers_js', 'oum_leaflet_gesture_js', 'oum_leaflet_markercluster_js' ),
            $this->plugin_version
        );
        wp_enqueue_script(
    ...
    public function ajax_add_location_from_frontend()
    {
        ...
        if ( !empty($_POST['action'] && $_POST['action'] == 'oum_add_location_from_frontend') ) {
            ...
            if ( isset( $_FILES['oum_location_audio']['name'] ) && $_FILES['oum_location_audio']['name'] != '' ) {
                $valid_extensions = array( 'mp3', 'wav', 'mp4' );
                // valid extensions
