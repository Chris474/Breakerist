...
if ( !oum_fs()->can_use_premium_code() ) {
    ?>
            ...
            <tr valign="top" class="oum-gopro-tr">
              <th scope="row">
                <?php 
    echo  __( 'Enable "Types" (marker categories) with individual marker icons', 'open-user-map' ) ;
    ?>
    ...
    ?></strong><br>
                <input disabled class="regular-text" type="text" value="" placeholder="Type">
              </td>
            </tr>
...
?>
            <th scope="row"><?php 
echo  __( 'Don\'t group markers that are close to each other (Clustering). ', 'open-user-map' ) ;
?></th>
            <td>
              <input class="oum-switch" type="checkbox" name="oum_disable_cluster" id="oum_disable_cluster" <?php 
echo  ( $oum_disable_cluster ? 'checked' : '' ) ;
?>>
...
?>
            <th scope="row"><?php 
echo  __( 'Disable fullscreen control', 'open-user-map' ) ;
?></th>
            <td>
              <input class="oum-switch" type="checkbox" name="oum_disable_fullscreen" id="oum_disable_fullscreen" <?php 
echo  ( $oum_disable_fullscreen ? 'checked' : '' ) ;
?>>
...
if ( !oum_fs()->can_use_premium_code() ) {
    ?>
            ...
            <tr valign="top" class="oum-gopro-tr">
              <th scope="row">
                <?php 
    echo  __( 'Enable current user location control', 'open-user-map' ) ;
    ?>
                <br><span class="oum-pro">PRO</span><br>
                <a class="oum-gopro-text" href="<?php 
    echo  oum_fs()->get_upgrade_url() ;
      ...
      <div id="tab-2" class="tab-pane">
        ...
        <table class="form-table">
          ...
          <tr class="top">
            <th scope="row">
              <label for="lat"><?php 
echo  __( 'Initial Map Focus', 'open-user-map' ) ;
?></label>
            </th>
            <td>
              <?php 
...
?>
            <th scope="row">
              <?php 
echo  __( 'Disable „Add location“ in the frontend', 'open-user-map' ) ;
?>
            </th>
            <td>
              <input class="oum-switch" type="checkbox" id="oum_disable_add_location" name="oum_disable_add_location" <?php 
echo  ( $oum_disable_add_location == 'on' ? 'checked' : '' ) ;
?>>
...
?>
            <th scope="row"><?php 
echo  __( '„Add location“-Button text"', 'open-user-map' ) ;
?></th>
            <td>
...
if ( !oum_fs()->can_use_premium_code() ) {
    ?>
            ...
            <tr valign="top" class="oum-gopro-tr">
              <th scope="row">
                <?php 
    echo  __( 'Public pages for locations', 'open-user-map' ) ;
    ?>
                <br><span class="oum-pro">PRO</span><br>
                <a class="oum-gopro-text" href="<?php 
    echo  oum_fs()->get_upgrade_url() ;
    ...
    ?></a>
              ...
              <td>
                ...
                <label></label><br><br>
                <span class="description"><?php 
    echo  __( 'This will add a "Read more"-Button to the location bubble. It will link to the location\'s single page. A content editor will become available.', 'open-user-map' ) ;
    ?></span><br><br>
              </td>
            </tr>
...
if ( !oum_fs()->can_use_premium_code() ) {
    ?>
            ...
            <tr valign="top" class="oum-gopro-tr">
              <th scope="row">
                <?php 
    echo  __( 'Admin email notification', 'open-user-map' ) ;
    ?>
                <br><span class="oum-pro">PRO</span><br>
                <a class="oum-gopro-text" href="<?php 
    echo  oum_fs()->get_upgrade_url() ;
...
if ( is_array( $oum_custom_fields ) ) {
    ...
    foreach ( $oum_custom_fields as $index => $custom_field ) {
        ?>
                      <tr>
                        <td>
                          <input type="text" name="oum_custom_fields[<?php 
        echo  $index ;
        ...
        ?>" />
                        ...
                        <td>
                          <input class="oum-switch" id="oum_custom_fields_<?php 
        echo  $index ;
        ?>" type="checkbox" name="oum_custom_fields[<?php 
        echo  $index ;
        ?>][required]" <?php 
        echo  ( isset( $custom_field['required'] ) ? 'checked' : '' ) ;
        ?> /><label for="oum_custom_fields_<?php 
        echo  $index ;
        ?>"></label>
                        </td>
                        <td>
                          <input class="small-text oum-custom-field-maxlength" type="number" min="0" name="oum_custom_fields[<?php 
        echo  $index ;
        ?>][maxlength]" value="<?php 
        ...
        ?>
                        ...
                        <td>
                          <input type="text" class="oum-custom-field-options" name="oum_custom_fields[<?php 
        echo  $index ;
        ?>][options]" placeholder="Red|Blue|Green" value="<?php 
        echo  ( isset( $custom_field['options'] ) ? esc_attr( $custom_field['options'] ) : '' ) ;
        ?>" /><br><br>
                          <label class="oum-custom-field-options oum-custom-field-allow-empty"><input type="checkbox" name="oum_custom_fields[<?php 
        echo  $index ;
        ?>][emptyoption]" <?php 
...
?></th>
            <td>
              <div class="oum_2cols">
                <div>
                  <input class="oum-switch" type="checkbox" name="oum_disable_title" id="oum_disable_title" <?php 
echo  ( $oum_disable_title ? 'checked' : '' ) ;
?>>
                  <label for="oum_disable_title"><?php 
echo  __( 'Disable', 'open-user-map' ) ;
?></label>
                </div>
                <div>
...
?></th>
            <td>
              <input class="oum-switch" type="checkbox" name="oum_disable_address" id="oum_disable_address" <?php 
echo  ( $oum_disable_address ? 'checked' : '' ) ;
?>>
              <label for="oum_disable_address"><?php 
echo  __( 'Disable', 'open-user-map' ) ;
?></label><br>
...
?></label><br>
              ...
              <input class="oum-switch" type="checkbox" name="oum_disable_gmaps_link" id="oum_disable_gmaps_link" <?php 
echo  ( $oum_disable_gmaps_link ? 'checked' : '' ) ;
?>>
              <label for="oum_disable_gmaps_link"><?php 
echo  __( 'Don\'t link address to Google Maps', 'open-user-map' ) ;
?></label><br><br>
            </td>
          </tr>
...
?></th>
            <td>
              <div class="oum_2cols">
                <div>
                  <input class="oum-switch" type="checkbox" name="oum_disable_description" id="oum_disable_description" <?php 
echo  ( $oum_disable_description ? 'checked' : '' ) ;
?>>
                  <label for="oum_disable_description"><?php 
echo  __( 'Disable', 'open-user-map' ) ;
?></label>
                </div>
                <div>
...
?></th>
            <td>
              <div class="oum_2cols">
                <div>
                  <input class="oum-switch" type="checkbox" name="oum_disable_image" id="oum_disable_image" <?php 
echo  ( $oum_disable_image ? 'checked' : '' ) ;
?>>
                  <label for="oum_disable_image"><?php 
echo  __( 'Disable', 'open-user-map' ) ;
?></label>
                </div>
                <div>
...
?></th>
            <td>
              <div class="oum_2cols">
                <div>
                  <input class="oum-switch" type="checkbox" name="oum_disable_audio" id="oum_disable_audio" <?php 
echo  ( $oum_disable_audio ? 'checked' : '' ) ;
?>>
                  <label for="oum_disable_audio"><?php 
echo  __( 'Disable', 'open-user-map' ) ;
?></label>
                </div>
                <div>
...
?></th>
            <td>
              ...
              <strong><?php 
echo  __( 'you can also override the initial map focus with shortcode attributes:', 'open-user-map' ) ;
?></strong><br><br>
              <code>[open-user-map lat="51.50665732176545" long="-0.12752251529432854" zoom="13" types="food|drinks" ids="123"]</code><br><br>
              <p class="hint"><?php 
echo  __( 'Set an individual map position with lat, long and zoom. Filter locations by Type or <a href="https://gigapress.net/how-to-find-a-page-id-or-post-id-in-wordpress/" target="_blank">Post ID</a>. Separate multiple Types or Post IDs with a | symbol.', 'open-user-map' ) ;
?></p><br><br>
