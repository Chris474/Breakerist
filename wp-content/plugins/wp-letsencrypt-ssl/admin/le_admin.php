    ...
    public function wple_cpanel_pricing_table( $cpanel = '' )
    {
      ...
      <?php 
        ...
        <div class="quick-refund-policy">
          ...
          <p>We're showing this recommendation because you have cPanel hosting where our PRO plugin is 100% guaranteed to work. Your purchase will be completely refunded WP Encryption fail to work on your site.</p>
        </div>
      <?php 
        }
        ?>
